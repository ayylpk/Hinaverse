...
from server.services.DiaryOfHinaService import DiaryOfHinaService
...
class DiaryCreateRequest(BaseModel):
    ...
    image_path: str = Field("", max_length=250, description="图片路径")
